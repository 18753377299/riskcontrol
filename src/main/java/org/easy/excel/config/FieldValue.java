...
public class FieldValue {
	...
	/** 数据库校验 */
	private boolean dcode;
	/** 邮箱校验 */
	private boolean isEmail;
	/** 电话号码校验 */
	private boolean isPhone;
	/** 查勘险类校验 */
	private boolean isRiskName;
	/** 是否为数字校验 */
	private boolean isNumberFlag;
	/** 保留小数位数 */
	...
	public void setDcode(boolean dcode) {
		this.dcode = dcode;
	}

	public boolean isRiskName() {
		return isRiskName;
	}

	public void setRiskName(boolean isRiskName) {
		this.isRiskName = isRiskName;
	}
	...
	public void setNumberFlag(boolean isNumberFlag) {
		this.isNumberFlag = isNumberFlag;
	}
